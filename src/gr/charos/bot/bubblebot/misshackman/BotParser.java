...
public class BotParser {
    ...
    private NotABotStarter bot;

    private BotState currentState;

    BotParser(NotABotStarter bot) {
            ...
            switch(key) {
                ...
                case "player_names":
                    ...
                    for (String playerName : playerNames) {
                        this.currentState.getPlayers().put(playerName, new BomberPlayer(playerName));
                    }
                    break;
                case "your_bot":
    ...
    private void parsePlayerData(String playerName, String key, String value) {
        BomberPlayer player = this.currentState.getPlayers().get(playerName);
